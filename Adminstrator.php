...
<body>
<div class="jumbotron" STYLE="background-color: #009933">
    <h3> ADMN DASHBOARD PRODUCT ADDITION</h3>
</div>
<div class="col-sm-12">
    <div class="col-sm-3" style="border: 2px solid #080808;height: 500px;">
        <ul class="nav nav-pills nav-stacked">
            <li class="active"><a href="Adminstrator.php">View Customer_Details</a></li>
            <li><a href="#">Login</a></li>
            <li><a href="#">View Daily_Records</a></li>
            <li><a href="#">Add Products</a></li>
            <li><a href="#">View Orders</a></li>
            <li><a href="#">View and Edit_Employees</a></li>
        </ul>
    </div>
    <div class="col-sm-9" style="border: 1px solid gold;height:auto;">
                        ...
                        <form class="col-lg-6" method="post" action="">
                            ...
                            if (isset($_POST['product'])) {
                                if ($category && $product_name && $description && $price && $quantity) {
                                    ...
                                    echo "<p class='alert alert-success'>Product added.<a href='Adminstrator.php?action=image'>Click here to enter product image<a></p>";
