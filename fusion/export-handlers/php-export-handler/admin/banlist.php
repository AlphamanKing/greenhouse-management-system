...
<div class="container">
    <header>
        <a href="./" title="FusionCharts - Delightful charts and gauges in JavaScript &amp; Flash"><img
                    src="fusioncharts-logo.png" width=""/></a>
    </header>
    <hr/>
    <div class="row">
        <div class="span3">
        ...
        <div class="span9">
            ...
            <div class="table-holder">
                <table class="table table-striped table-hover table-condensed">
                    <thead>
                    <tr>
                        <td colspan="4"><h4>Disallowed IPs</h4></td>
                        <td colspan="2" style="text-align:right"><a href="javascript:void('0');"
                                                                    onclick="deleteSelected();" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>

                    <tr>
                        <td><strong>Ip Disallowed</strong></td>
                        <td><strong>User who added</strong></td>
                    ...
                    if (mysql_num_rows($selectRes) > 0) {
                        while ($selectRows = mysql_fetch_assoc($selectRes)) {
                            ?>
                            <tr>
                                <td><?php echo $selectRows['ip']; ?></td>
                                <td><?php echo $selectRows['userAdded']; ?></td>
                                <td><?php echo $selectRows['dateAdded']; ?></td>
                                <td><?php echo $selectRows['reason']; ?></td>
                                <td><a href="editRule.php?id=<?php echo $selectRows['id']; ?>"
                                       class="btn btn-mini fancy-add" alt=""><i class="icon-edit"></i> EDIT</a></td>
                                <td><input type="checkbox" class="checkbox" name="selectDelete"
                                           id="<?php echo $selectRows['id']; ?>"/></td>
                            </tr>
                    ...
                    <tfoot>
                    <tr>
                        <td colspan="6" style="text-align:right"><a href="javascript:void('0');"
                                                                    onclick="deleteSelected();" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
                    </tfoot>
