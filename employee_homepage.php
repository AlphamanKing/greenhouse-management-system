...
if ($_SESSION['username']) {
    ...
    $check = ("SELECT * FROM employee WHERE username='" . $_SESSION['username'] . "'");
    $rows = mysqli_query($con,$check);
        ...
        while ($row = mysqli_fetch_assoc($rows)) {
            ...
            <div id="wrap">
                ...
                <div id="mainnav">
                    ...
                    <div class="dropdown">
                        <a href="employee_homepage.php?link=updates">
                            <button class="dropbtn">view updates</button>
                        </a>
                    </div>
                    <div class="dropdown">
                        <a href="employee_homepage.php?link=data_entry">
                            <button class="dropbtn">Daily data Entry</button>
                        </a>
                    </div>
                    <div class="dropdown">
                        <a class="leave_history1" href="#">
            ...
            <div id="rightcol">
                <?php
                if (@$_GET['link'] == "data_entry") {
                    include("data.php");
                } elseif (@$_GET['link'] == "updates") {
                    include("viewupdates.php");
                } elseif (@$_GET['link'] == "profile") {
                    include("leave history1.php");
                } else {
                    include("home.php");
                }
                ?>
