<?php
echo "<span style='color:orange;font-weight:bold;'>Upload cover image for " . $_SESSION["empId"] . " </span>";
?>
...
<form method="post" action="" enctype="multipart/form-data">
    ...
    if (isset($_POST['upload_photo'])) {
        ...
        $check = mysqli_query($con, "SELECT * FROM products WHERE product_name='" . $_SESSION['empId'] . "'");
        ...
        if (empty($errors)) {
            ...
            if ($query = mysqli_query($con, "UPDATE employee set product_image= '" . $image_up . "' WHERE product_name='" . $_SESSION['empId'] . "'")) {
