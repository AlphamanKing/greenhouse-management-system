    ...
    <body>
        <div class="container">
            <form action='express-stk.php' method='POST'>
                <!-- Hidden fields to carry over the cart details -->
                ...
                <div class="price">
                    <h1>Awesome, that's KES <?php echo htmlspecialchars($_POST['amount']); ?></h1>
                </div>
                ...
                <div class="button">
                    <button type="submit"><i class="ion-locked"></i> Proceed to Pay</button>
                </div>
            </form>
        </div>
    </body>
