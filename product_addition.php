...
<head>
    ...
    <title>new products | Greenhouse SHOP</title>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="logo pull-left">
                    <h3 style="color:#006600;">Greenhouse ADmin Dashboard</h3>
                </div>
                    ...
                    <ul class="nav navbar-nav collapse navbar-collapse">
                        ...
                        <li class="dropdown"><a href="#">View<i class="fa fa-angle-down"></i></a>
                            <ul role="menu" class="sub-menu">
                                ...
                                <li><a href="#">View Employee Records</a></li>
                                <li><a href="#">Cart</a></li>
    ...
    <div class="signup-form">
        ...
        <footer id="footer"><!--Footer-->
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <p class="pull-left">Copyright Â© 2018 GREENHOUE-SHOP Inc. All rights reserved.</p>
                        <p class="pull-right">Designed by <span><a target="_blank" href="http://www.elikzo.com">kelvinmutunga</a></span>
                        </p>
                    </div>
                </div>
            </div>
