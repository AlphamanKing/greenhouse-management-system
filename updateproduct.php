...
<div class="row section">
    <div class="col-lg-10">
        ...
        <div class="row header">
            <h3 class="h3">UPDATE THE PRODUCTS</h3>
            <hr/>
            <div class="form">
                <form class="col-lg-6" method="post" action="">
                    <input class="form-control" type="integer" name="product_id" placeholder="product_id"/><br/>
                    ...
                    <button class="btn btn-block btn-success" type="submit" name="product">UPDATE PRODUCT
                    </button>
                    ...
                    if (isset($_POST['product'])) {
                        if ($category && $product_name && $description && $price && $quantity && $product_id) {
                            $querry = mysqli_query($con, "UPDATE  products  SET $category=?,$product_name=?,$description=?,$price,$quantity=? WHERE $product_id=?");
                              $update=$con->prepare($querry);
                              $update->bind_param($product_id,$category,$description,$price,$quantity);
                              $update->execute();
